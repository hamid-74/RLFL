...
result_folder_name = 'results/constant/mnist_Non_IID_0/'
...
def dump_stats(global_acc_loss_action, global_accs, accs_all_clients, max_acc_achieved,folder_name, start_point, run):
