...
value_network = tf.keras.models.Sequential([
    tf.keras.layers.Dense(200, activation='relu', input_shape=(input_shape_RL,)),
...
num_episodes_RL = 2000
epsilon_RL = 1
gamma_RL = 0.9
batch_RL = 50
replay_RL = deque(maxlen=2000)
epoch_RL = 0
alpha_RL = 0.1
episode_RL = 0
    ...
    #         print('client_names', client_names, len(client_names))
        ...
        if(comm_round>1): 
            ...
            for iiii in range(10):
                next_state = next_state + accs_all_clients[iiii][comm_round]
                
            next_state = next_state + global_accs[comm_round - 1]
