...
runs = [ 'run3'] # 3 4 5 next

result_folder_name = '../results/benchmarks/tmean/' + dataset + '/' + distribution + '/'
...
for run in runs:
    ...
    for comm_round in range(comms_round):
        ...
        tmean_weights = calculate_tmean(scaled_local_weight_list)


        #update global model 
        global_model.set_weights(tmean_weights)
